...
public class RoomManagementAdapter extends BaseAdapter {
    ...
    public RoomManagementAdapter(Context context, List<RoomModel> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View itemView = inflater.inflate(R.layout.customroomaccept, parent, false);
        ...
        TextView price = itemView.findViewById(R.id.room_price);
        TextView status = itemView.findViewById(R.id.room_status);// Sử dụng itemView ở đây
        status.setText(roomModel.getStatus());
        Picasso.get()
